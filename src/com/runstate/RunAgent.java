...
public class RunAgent {
    ...
    private static final String SYSTEM_PROMPT =
            "You are RunState — a supportive running mentor. You respond after every logged run.\n\n"
                    ...
                    + "punch. Aim for 25 to 30 words and never exceed 35. Shorter is welcome "
                    + "when the strongest idea lands cleanly. Keep it rich and compressed, "
                    + "never stretched thin. When a reply runs long, cut explanation and "
                    + "restatement — never the creative connection.\n\n"
    ...
    private static final String MUSIC_REPLY_RULES =
            "Music reply rules:\n"
                    ...
                    + "timing, streaming or provider metadata, playback history, or how often "
                    + "music came up in past replies.\n"
