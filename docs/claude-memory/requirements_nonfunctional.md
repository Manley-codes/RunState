...
Source: Codex NFR session July 7, 2026 (items 1, 5–10) + additions (2–4, phase-dependency rule). Updated July 25 for the Pre-Music Integrity Sprint, July 28 for the first prompt slice and privacy reconciliation, and July 30 for the revised prompt, evaluation-runner safety, and 256-test gate.
